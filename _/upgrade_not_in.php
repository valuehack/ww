...
<div class="payment">
           <div class="payment_info">
           	<?php  
				$upgrade_info = $general->getStaticInfo('upgrade');
				echo $upgrade_info->info;			
			?>
           </div>
            ...
            <div class="pay_option_box pay_option_box2">
               <table>
                    ...
                    <td class="pay_option_form" colspan="2">
                        <form method="post" action="/zahlung/?g=ihredaten">
                        	<input type="hidden" name="product[type]" value="upgrade">
                            <input type="hidden" name="product[what]" value="upgrade_3">
        ...
        <div id="selected" class="pay_option_box pay_option_box3">
            <table>
                ...
                <td class="pay_option_form" colspan="2">
                    <form method="post" action="/zahlung/?g=ihredaten">
                    	<input type="hidden" name="product[type]" value="upgrade">
                        <input type="hidden" name="product[what]" value="upgrade_4">
                        <input type="hidden" name="product[price]" value="300">
        ...
        <div class="pay_option_box pay_option_box4">
            <table>
                ...
                <td class="pay_option_form" colspan="2">
                    <form method="post" action="/zahlung/?g=ihredaten">
                    	<input type="hidden" name="product[type]" value="upgrade">
                        <input type="hidden" name="product[what]" value="upgrade_5">
                        <input type="hidden" name="product[price]" value="600">
		...
		<div class="pay_option_box pay_option_box5">
            <table>
                ...
                <td class="pay_option_form" colspan="2">
                    <form method="post" action="/zahlung/?g=ihredaten">
                    	<input type="hidden" name="product[type]" value="upgrade">
                        <input type="hidden" name="product[what]" value="upgrade_6">
        ...
        <div class="pay_option_box pay_option_box6">
            <table>
                ...
                <td class="pay_option_form" colspan="2">
                    <form method="post" action="/zahlung/?g=ihredaten">
                    	<input type="hidden" name="product[type]" value="upgrade">
                        <input type="hidden" name="product[what]" value="upgrade_7">
                        <input type="hidden" name="product[price]" value="2400">
