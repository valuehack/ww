...
define("MESSAGE_EMAIL_ALREADY_EXISTS", "E-Mail-Adresse bereits registriert. Ein Passwort wurde Ihnen zugesandt. <a href='/password_reset.php'>Passwort vergessen?");
...
define("MESSAGE_LOGIN_FAILED", "Login fehlgeschlagen (falsches Passwort?)");
...
define("MESSAGE_REGISTRATION_ACTIVATION_NOT_SUCCESSFUL", "Fehler bei Aktivierung, bei Problemen Mail an info@scholarium.at");
