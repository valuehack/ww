 ...
 */
define("DB_HOST", "newBig.db.6152056.hostedresource.com");
define("DB_NAME", "newBig");
define("DB_USER", "newBig");
define("DB_PASS", "bmbClat1!");
#https://n1nlsmysqladm01.secureserver.net/grid55/13/index.php
#mitgliederExt
#newBig.db.6152056.hostedresource.com
#newBig
#bmbClat1!
 ...
 *
 * COOKIE_RUNTIME: How long should a cookie be valid ? 1209600 seconds = 2 weeks/ 31449600 = 1 year
 * COOKIE_DOMAIN: The domain where the cookie is valid for, like '.mydomain.com'
 * COOKIE_SECRET_KEY: Put a random value here to make your app more secure. When changed, all cookies are reset.
 */
define("COOKIE_RUNTIME", 31449600);
define("COOKIE_DOMAIN", ".127.0.0.1");
define("COOKIE_SECRET_KEY", "1gp@xycTMPS{+fpMJcyxFefaewi745-92s");
 ...
 */
define("EMAIL_PASSWORDRESET_URL", "http://test.wertewirtschaft.net/password_reset.php");
define("EMAIL_PASSWORDRESET_FROM", "no-reply@example.com");
define("EMAIL_PASSWORDRESET_FROM_NAME", "My Project");
define("EMAIL_PASSWORDRESET_SUBJECT", "Password reset for your werte account");
 ...
 */
define("EMAIL_VERIFICATION_URL", "http://localhost/werte/website/register.php");
