...
<?php
	while($entry = mysql_fetch_array($result))
	{
     ...
     ?> 
		...
		var info = '<div class="map_info"><a href="index.php?q=<?=$id?>"><h1><?=$name?></h1></a><img src="<?=$img?>" alt=""><p><?=substr($text, 0, 180)?> ... <a href="index.php?q=<?=$id?>">Mehr</a></p><p><h2>Wirkende Denker</h2><?=$denker?></p></div>';
