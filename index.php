...
//do not redirect if user clicked "Zur deutschsprachigen Startseite"-link on English page
if ($_GET['sprache'] != "de" || !isset($_GET['sprache'])) {
	
//we only need the first two letters (so de-at is the same as de-ch etc.)
$lang = substr($_SERVER['HTTP_ACCEPT_LANGUAGE'], 0, 2);

// function to determine the country according to the ip-address
