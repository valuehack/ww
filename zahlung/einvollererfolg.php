	...
	<div class="content-area">
		<div class="row-group">
			<div class="row row__body">
				<div class="col-8">
					<p>Vielen Dank f&uuml;r Ihre Unterst&uuml;tzung. Die Zahlung wurde erfolgreich durchgef&uuml;hrt. In K&uuml;rze erhalten Sie eine Nachricht als Best&auml;tigung.</p>
				</div>
			</div>
		</div>
	</div>
