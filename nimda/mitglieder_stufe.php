...
<html lang="de">
	<head>
		...
		<title>Mitgliederliste (nach Stufe sortiert)</title>
...
<?php
	...
	$user_query = "SELECT * from mitgliederExt WHERE Mitgliedschaft > 1 || Zahlung != '' order by Mitgliedschaft DESC, Nachname ASC";
