...
<p>craftprobe is an entrepreneurial gap year program (two months to one year) in Vienna, Austria, offering a limited number of selected participants a unique educational and work experience where they can develop, with the support of some of the best brains and tools and through entrepreneurial projects, practical experiments and profound reflection, the necessary skills and ideas to create real value. Not the fake value pseudo-managers and pseudo-politicians are offering: either some over-hyped shiny stuff you do not need, to be paid for with money you do not have, or the fiction by which everyone tries to live at the expense of everybody else. Cut the crap, get real!</p>
