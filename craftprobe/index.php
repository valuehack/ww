...
<html lang="en">
    ...
    <body>
        ...
        <?   if($ok == 1) {
		echo '<div class="ok">
			<h1>Thank you for your interest in <b>craft</b><span class="fontchange">probe</span>!</h1>
			<p>You successfully submitted your boarding request.</p>
		</div>';
}
?>
        <div class="banner">
            <div class="bannerimg" style="background-image: url(img/iceship2.jpg);"></div>
            <div class="bannerms">
        ...
        <div class="content">
            <section id="about" class="s1">
            	<p>Sense: the final frontier. These are the voyages of <b>craft</b><span class="fontchange">probe</span>, an exploratory enterprise. Its mission: to explore alternatives to create real value and make sense, to boldly pierce through the endless swaths of bullshit that surround us every day in search of intelligent life. Our craft is a perpetual start-up, with some of the coolness, but none of the hype.</p>

<p><b>craft</b><span class="fontchange">probe</span> is an entrepreneurial gap year program (two months to one year) in Vienna, Austria, offering a limited number of selected participants a unique educational and work experience where they can develop, with the support of some of the best brains and tools and through entrepreneurial projects, practical experiments and profound reflection, the necessary skills and ideas to create real value. Not the fake value pseudo-managers and pseudo-politicians are offering: either some over-hyped shiny stuff you do not need, to be paid for with money you do not have, or the fiction by which everyone tries to live at the expense of everybody else. Cut the crap, get real!</p>

<p><b>craft</b><span class="fontchange">probe</span> is a systematic reality check, always intent to build real things and develop real solutions, as it is run by an enterprise and not an agency, program or school. In view of the hugely distorted markets the shareholders of <b>craft</b><span class="fontchange">probe</span>&apos;s mothership do not strive to pocket quick profits but to develop a unique entrepreneurial laboratory to find feasible, small-scale solutions for tomorrow&apos;s problems.</p>
            ...
            <section id="manual" class="s2">
				...
				<p>The most common options are:</p>
					<ol>
						...
						<li>After your Bachelor&apos;s degree, when considering or waiting for enrollment for a Master&apos;s degree. Many students face extended periods in doubt and frustration. Do not waste this time! <b>craft</b><span class="fontchange">probe</span> is the perfect gap filler, next to which in retrospect your studies and degrees will fade in importance.</li>
						<li>After finishing university and when trying to enter the job market. You will realize that it is getting more and more difficult to land a job right out of university. Have you considered entrepreneurial alternatives? Even if you just want to grow personally, develop a network and get a head-start for your professional career, by making up for all the real-life lessons university has spared you, <b>craft</b><span class="fontchange">probe</span> is just what you are looking for.</li>
					</ol>
