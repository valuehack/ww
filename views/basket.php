...
if($_SESSION['basket']) { 
    ...
    echo "</table><hr>";      
?>
<a class="scholien" href="<?php downloadurl('http://test.wertewirtschaft.net/secdown/sec_files/scholien0214.pdf','scholien0214'); ?>" onclick="updateReferer(this.href);">03/14 Universit&auml;t (Test secureDownload)</a>
