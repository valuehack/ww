...
//Array with all the selected items:
if($_SESSION['basket']) { 
    ...
    foreach ($items as $key => $quantity) {
       $items_extra_query = "SELECT * from termine WHERE `id` LIKE '%$key%' ORDER BY start DESC";
        ...
        //$items_extra_query = sprintf("SELECT * from termine WHERE id = %d;", $add_id); 
...
<table style="width:100%"><tr><td style="width:80%">
    ...
    <input type="submit" name="delete" value="Clear Basket"></form></td>
    <td align="right"><a href="">Go to Checkout</a></td></tr>
</table>
