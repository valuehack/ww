...
//Pagination Script found at http://www.phpeasystep.com/phptu/29.html
  ...
  */
  $query = "SELECT COUNT(*) as num FROM $tbl_name WHERE `type` LIKE 'programm'AND status = 1";
  ...
  /* Get data. */
  $sql = "SELECT * from produkte WHERE `type` LIKE 'programm' AND status = 1 order by n desc LIMIT $start, $limit";
