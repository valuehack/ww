...
?>
	<div class="content-area">
		...
		<div class="centered">
			<a href="<?php downloadurl($file_path,$product_info->id);?>" onclick="updateReferer(this.href);"> <button type="button" class="inputbutton">Audio-Aufzeichnung als MP3-Datei herunterladen</button></a>
		</div>
<?php
