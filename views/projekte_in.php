        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
        	<form method="post" action="../abo/zahlung.php" name="user_create_profile_form">
              ...
              <input type="radio" class="projekte_investment_radio" name="betrag" value="2400">2400&euro;: Ab diesem Beitrag werden Sie Patron und bestimmen bis zu zweimal im Jahr ein Thema f&uuml;r das <i>scholarium</i>.<br>
        	</div>
