...
<?php		
  ...
  if ($_SESSION['Mitgliedschaft'] == 1) { 
    ...
    <?php
		...
		<p>Interessierte Mitglieder haben bereits <span class='projekte_price_list'><li><span class='projekte_credits_sold'>".$entry[spots_sold]."</span> von <span class='projekte_credits_sold'>".$entry[spots]."</span> n&ouml;tigen</li> <li class='projekte_coin'><img src='../style/gfx/coin.png'></li></span> investiert.</p>"; ?>
      	<form class="projekte_invest_form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
        	...
        	<span class="projekte_invest_span"><span class='projekte_coin'><img src='../style/gfx/coin.png'></span> zu diesem Projekt beitragen.</span><br>
