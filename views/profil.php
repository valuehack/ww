...
<br> 
        <input id="user_first_name" type="text" value="<?php echo $vorname; ?>" name="profile[user_first_name]" required />
<br>
        <label for="user_surname">Nachname</label>
<br> 
        <input id="user_surname" type="text" value="<?php echo $nachname; ?>" name="profile[user_surname]" required />
<br>
        <label for="user_street">Straße</label>
<br> 
        <input id="user_street" type="text" value="<?php echo $strasse; ?>" name="profile[user_street]" required />
<br>
...
<br> 
        <input id="user_city" type="text" value="<?php echo $ort; ?>" name="profile[user_city]" required />
<br>
