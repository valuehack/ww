      ...
      elseif ($entry3[start]!= NULL)
		...
		<div class="centered">
			<div class="salon_reservation">
				<p class="salon_reservation_span_d"><?echo $entry3[price]?> &euro; pro Teilnehmer</p>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
      ...
      <div class="modal-body">
    		<form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" name="user_create_profile_form">
				...
				<div class="salon_input">
        			<input class="salon_inputfield" id="user_email" type="email" name="profile[user_email]" required /><br> 
        			<input class="salon_inputfield" id="user_first_name" type="text" name="profile[user_first_name]" required /><br>
        			<input class="salon_inputfield" id="user_surname" type="text" name="profile[user_surname]" required /><br>
        			<input class="salon_inputfield" id="user_street" type="text" name="profile[user_street]" required /><br> 
        			<input class="salon_inputfield" id="user_plz" type="text" name="profile[user_plz]" required /><br>
        			<input class="salon_inputfield" id="user_city" type="text" name="profile[user_city]" required /><br>
    ...
    <input type="submit" class="inputbutton" name="registrationform" value="Anmelden"/>
    </form>
