...
<hr>
    ...
    <input type="radio" name="zahlung" value="kredit"/>Paypal<br>
    <input type="radio" name="zahlung" value="bar"/>BAR<br>
<hr><br>

    <input type="submit" name="upgrade_user_account" value="Upgrade" />
</form>
<br>
...
<br><p>Bitte geben Sie Ihre Daten ein:</p><br>
...
?>
    ...
    <p>Alternativ k&ouml;nnen Sie den Gegenwert in Schweizer Franken auf folgendes Konto &uuml;berweisen:</p><br>
