		...
		<div class="schriften_bestellen">
    		...
    		<?php
    			if ($entry3[format] == '0001') {
    				echo '<span id="total2" class="schriften_price">'.$entry3[price].' <img class="et_img" src="../style/gfx/scholarium_logo_credits.png"></span>';
					echo '<input type="submit" class="inputbutton" value="Ausw&auml;hlen"><br>';
				}
				else {
					echo '<span id="price" class="schriften_price">' .$entry3[price].' <img class="et_img" src="../style/gfx/scholarium_logo_credits.png"></span>';
					echo '<input type="submit" class="inputbutton" value="Ausw&auml;hlen"><br>';
				}
