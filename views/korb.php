...
<?
        ...
        foreach ($items as $code => $quantity) {
            ...
            if ($itemsExtraArray[type] == 'programm' ||  $itemsExtraArray[type] == 'vortrag' || $itemsExtraArray[title] == 'Intensives Orientierungscoaching für realistische Karriere- und Bildungswege') {
			//E-Mail an uns
